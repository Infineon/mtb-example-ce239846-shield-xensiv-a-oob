...
static GUI_CONST_STORAGE APPW_ACTION_ITEM _aAction[] = {
  { btn_stat,     WM_NOTIFICATION_VALUE_CHANGED,    0,            APPW_JOB_SHOWSCREEN,     ID_SCREEN_07__WM_NOTIFICATION_VALUE_CHANGED,
    { ARG_V(ID_SCREEN_01),
    }, 0, NULL
  },
};
