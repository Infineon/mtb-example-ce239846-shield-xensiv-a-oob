...
static GUI_CONST_STORAGE APPW_SETUP_ITEM _aSetup[] = {
  ...
  { ID_TEXT_03,   APPW_SET_PROP_FONT,         { ARG_VP(0, acRoboto_16_Normal_EXT_AA4) } },
};
...
static GUI_CONST_STORAGE APPW_ACTION_ITEM _aAction[] = {
  { btn_stat,     WM_NOTIFICATION_VALUE_CHANGED,    0,            APPW_JOB_SHOWSCREEN,     ID_SCREEN_03__WM_NOTIFICATION_VALUE_CHANGED,
    { ARG_V(ID_SCREEN_04),
    }, 0, NULL
  },
};
