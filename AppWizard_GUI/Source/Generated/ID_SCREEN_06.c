...
static APPW_CREATE_ITEM _aCreate[] = {
  ...
  { WM_OBJECT_TEXT_Create,
    ...
    { { { DISPOSE_MODE_REL_PARENT, 82, 0, 0 },
        { DISPOSE_MODE_REL_PARENT, 45, 0, 0 },
        { DISPOSE_MODE_NULL, 0, 0, 0 },
        { DISPOSE_MODE_NULL, 0, 0, 0 },
      },
...
static GUI_CONST_STORAGE APPW_SETUP_ITEM _aSetup[] = {
  ...
  { ID_TEXT_03,   APPW_SET_PROP_ALIGNTEXT,    { ARG_V(GUI_ALIGN_LEFT | GUI_ALIGN_VCENTER),
                                                ARG_V(0),
                                                ARG_V(0) } },
  { ID_TEXT_03,   APPW_SET_PROP_TEXTID,       { ARG_V(ID_RTEXT_14) } },
  { ID_TEXT_03,   APPW_SET_PROP_FONT,         { ARG_VP(0, acCalibri_14_Normal_EXT_AA4) } },
  { ID_TEXT_01,   APPW_SET_PROP_COLOR,        { ARG_V(GUI_BLACK) } },
  { ID_TEXT_01,   APPW_SET_PROP_FONT,         { ARG_VP(0, acCalibri_14_Normal_EXT_AA4) } },
  ...
  { ID_TEXT_04,   APPW_SET_PROP_ALIGNTEXT,    { ARG_V(GUI_ALIGN_LEFT | GUI_ALIGN_VCENTER),
                                                ARG_V(0),
                                                ARG_V(0) } },
  { ID_TEXT_04,   APPW_SET_PROP_TEXTID,       { ARG_V(ID_RTEXT_15) } },
  { ID_TEXT_04,   APPW_SET_PROP_FONT,         { ARG_VP(0, acCalibri_14_Normal_EXT_AA4) } },
  { ID_TEXT_02,   APPW_SET_PROP_COLOR,        { ARG_V(GUI_BLACK) } },
  { ID_TEXT_02,   APPW_SET_PROP_ALIGNTEXT,    { ARG_V(GUI_ALIGN_LEFT | GUI_ALIGN_VCENTER),
                                                ARG_V(0),
                                                ARG_V(0) } },
  { ID_TEXT_02,   APPW_SET_PROP_FONT,         { ARG_VP(0, acCalibri_14_Normal_EXT_AA4) } },
};
...
static GUI_CONST_STORAGE APPW_ACTION_ITEM _aAction[] = {
  { btn_stat,     WM_NOTIFICATION_VALUE_CHANGED,    0,            APPW_JOB_SHOWSCREEN,     ID_SCREEN_06__WM_NOTIFICATION_VALUE_CHANGED,
    { ARG_V(ID_SCREEN_07),
    }, 0, NULL
  },
};
